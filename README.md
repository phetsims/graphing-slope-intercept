...
=============
"Graphing Slope-Intercept" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/graphing-slope-intercept/latest/graphing-slope-intercept_en.html" target="_blank">Click here to
run "Graphing Slope-Intercept".</a>
...
(5) Open in the browser: `http://localhost/graphing-slope-intercept/graphing-slope-intercept_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/graphing-slope-intercept/build/adapted-from-phet/graphing-slope-intercept_en_adapted-from-phet.html` (You will
